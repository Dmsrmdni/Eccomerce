...
@section('content')
    ...
    <div class="card shadow-lg rounded card p-2">
        <div class="card-header" id="#atas">
            ...
            <a href="{{ route('alamat.create') }}" class="btn btn-sm btn-primary float-end "><svg
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('alamat.destroy', $alamat->id) }}" method="post"
                                            ...
                                            {{-- <a href="{{ route('alamat.show', $alamat->id) }}" class="btn btn-sm btn-info"
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalCenter{{ $alamat->id }}" tabindex="-1"
                                                aria-hidden="true">

...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('reviewProduk.store') }}" method="POST">
            @csrf
            <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="rating" min="1" max="5"
                                class="form-control mb-2  @error('rating') is-invalid @enderror" value="1">
                            @error('rating')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ url('/admin/reviewProduk') }}" class="btn btn-danger me-3"><svg

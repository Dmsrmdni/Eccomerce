                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg"
                                    ...
                                    <ul class="product__hover">
                                        <li><a href="#"><span class="icon_heart_alt"></span></a></li>
                                        <li><a href="produk/{{ $on_diskon->id }}"><span class="arrow_expand"></span></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="product__item__text">
            ...
            <div class="row">
                    ...
                    <div class="trend__content">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('users/assets/img/trend/ht-1.jpg') }}" alt="">
                            </div>
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('users/assets/img/trend/ht-2.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('users/assets/img/trend/ht-3.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="trend__content">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('users/assets/img/trend/bs-1.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                                <h6>Cotton T-Shirt</h6>
                                <div class="rating">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('users/assets/img/trend/bs-2.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('users/assets/img/trend/bs-3.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="trend__content">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('users/assets/img/trend/f-1.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('users/assets/img/trend/f-2.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
                        ...
                        <div class="trend__item">
                            <div class="trend__item__pic">
                                <img src="{{ asset('users/assets/img/trend/f-3.jpg') }}" alt="">
                            </div>
                            <div class="trend__item__text">
            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="discount__pic">
                        <img src="{{ asset('users/assets/img/discount.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-6 p-0">
